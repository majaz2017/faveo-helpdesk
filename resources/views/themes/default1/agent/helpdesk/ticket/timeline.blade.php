...
<li>
    ...
    <a href="#">
        ...
        <small class="pull-right">
            ...
            <input type="radio" class="star not-apply" id="star5" name="{!! $rating->name !!}" value="{!! $i !!}"
    ...
    <div class="box-header">
        ...
        <div class="pull-right">
            ...
            <button type="button" class="btn btn-sm btn-default" id="Edit_Ticket" data-toggle="modal"
                data-target="#Edit"><i class="fa fa-edit" style="color:green;"> </i> {!! Lang::get('lang.edit')
                !!}</button>
            <?php } ?>

            <?php if ($group->can_assign_ticket == 1) { ?>
            <button type="button" class="btn btn-sm btn-default" data-toggle="modal"
                data-target="#{{$tickets->id}}assign"><i class="fa fa-hand-o-right" style="color:orange;"> </i> {!!
                Lang::get('lang.assign') !!}</button>
            <?php } ?>

            @if($tickets->assigned_to == Auth::user()->id)
            <button type="button" id="surrender_button" class="btn btn-sm btn-default" data-toggle="modal"
                data-target="#surrender"> <i class="fa fa-arrows-alt" style="color:red;"> </i> {!!
                Lang::get('lang.surrender') !!}</button>
            @endif
            ...
            <div class="btn-group">
                <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" id="d1"><i
                        class="fa fa-exchange" style="color:teal;" id="hidespin"> </i><i class="fa fa-spinner fa-spin"
                        style="color:teal; display:none;" id="spin"></i>
                    {!! Lang::get('lang.change_status') !!} <span class="caret"></span>
                </button>
                <ul class="dropdown-menu">
                    <li id="open"><a href="#"><i class="fa fa-folder-open-o" style="color:red;"> </i>{!!
                            Lang::get('lang.open') !!}</a></li>

                    <?php if ( $tickets_approval->status==7) {?>
                    @if(Auth::user()->role == 'admin')
                    <li id="approval_close"><a href="#"><i class="glyphicon glyphicon-thumbs-up" style="color:red;">
                            </i>{!! Lang::get('lang.approval') !!}</a></li>
                    @endif
                    ...
                    <li id="close"><a href="#"><i class="fa fa-check" style="color:green;"> </i>{!!
                            Lang::get('lang.close') !!}</a></li>
                    <?php } ?>
                    <?php } ?>
                    ...
                    <li id="resolved"><a href="#"><i class="fa fa-check-circle-o " style="color:green;"> </i>{!!
                            Lang::get('lang.resolved') !!} </a></li>
                </ul>
            </div>
            <?php if ($group->can_delete_ticket == 1 || $group->can_ban_email == 1) { ?>
            <div id="more-option" class="btn-group">
                <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" id="d2"><i
    ...
    <div class="box-body">
        ...
        <div class="row">
            <section class="content">
                        ...
                        <div class="callout callout-{{$priority->priority_color}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    @endforeach
                                    <b>{!! Lang::get('lang.last_response') !!}: </b>
                                    {{ UTC::usertimezone($ResponseDate) }}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        ?>
                                <table class="table table-hover">
                                    <div id="refresh3">
                                        ...
                                        @if($user->phone_number !=null)<tr>
                                            <td><b>{!! Lang::get('lang.phone') !!}:</b></td>
                                            <td>{{$user->phone_number}}</td>
                                        </tr>@endif
                                        @if($user->mobile !=null)<tr>
                ...
                @if($help_topic->useGeo)
                <div class="col-md-4">
                    <div id="mapid" style="width: 400px; height: 200px;"></div>
                </div>
                @endif
            </section>
        </div>
    ...
    <div class='col-xs-12'>
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="#Internal" data-toggle="tab" style="color:#0495FF;" id="bb"><i class="fa fa-file-text">
                        </i> {!! Lang::get('lang.internal_notes') !!}</a></li>
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <div id="refreshTo">
                                                ...
                                                {!! $errors->first('To', '<spam class="help-block text-red">:message
                                                </spam>') !!}
                                                <a href="#" data-toggle="modal" data-target="#addccc"> {!!
                                                    Lang::get('lang.add_cc') !!} </a>
                                                <div id="recepients">
                                                    <?php
                                                ...
                                                ?>
                                                    ...
                                                    <a href="#" data-toggle="modal" data-target="#surrender2">({!!
                                                        $count_collaborator !!}) {!! Lang::get('lang.recepients') !!}
                                                    </a>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        ?>
                                            <option value="zzz">{!! Lang::get('lang.select_a_canned_response') !!}
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}"
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            {!! $errors->first('reply_content', '<spam class="help-block text-red">
                                                :message</spam>') !!}
    ...
    removeButtons: 'Underline,Strike,Subscript,Superscript,Anchor,Styles,Specialchar'
                                        ...
                                        <div class="col-md-10">
                                            <div id="reset-attachment">
                                                <span class='btn btn-default btn-file'> <i class='fa fa-paperclip'></i>
                                                    <span>{!! Lang::get('lang.upload') !!}</span><input type='file'
                                                        name='attachment[]' id='attachment' multiple /></span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}"
                                        ...
                                        <div class="col-md-2">
                                            <label>{!! Lang::get('lang.internal_note') !!}:<span class="text-red">
                                                    *</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div id="newtextarea1">
                                                <textarea class="form-control" name="InternalContent"
                                                    id="InternalContent" style="width:98%; height:150px;"></textarea>
                                            </div>
                                            {!! $errors->first('InternalContent', '<spam class="help-block text-red">
                                                :message</spam>') !!}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <ul class="timeline">
                        ...
                        <li>
                            ...
                            <div class="timeline-item">
                                    ...
                                    <div class="pull-right">
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>
                                                        <div class="ticketratingtitle" style="color:#3c8dbc;">{!!
                                                            $rating->name !!} &nbsp;</div>
                                                    </th>&nbsp
                                                    <td style="button:disabled;">
                                                        <?php for ($i = 1; $i <= $rating->rating_scale; $i++) { ?>
                                                        <input type="radio" class="star star-rating-readonly not-apply"
                                                            id="star5"
                                ...
                                <h3 class="timeline-header">
                                    ...
                                    <div class="user-block" style="margin-bottom:-5px;margin-top:-2px;">
                                        ...
                                        <img src="{{asset('lb-faveo/media/images/avatar_1.png')}}"
                                            class="img-circle img-bordered-sm" alt="img-circle img-bordered-sm">
                                        @endif
                                        ...
                                        <span class="description" style="margin-bottom:4px;margin-top:4px;"><i
                                            ...
                                            {{UTC::usertimezone($conversation->created_at)}}</span>
                                ...
                                <div class="timeline-body{{$conversation -> id}} arindam"
                                    style="padding-right:30px !important;margin-bottom:-20px;margin-top: 15px;">
                                    @else
                                    <div class="timeline-body{{$conversation -> id}} arindam"
                                        style="padding-left:30px;margin-bottom:-20px;margin-top: 15px;">
                                        @endif
        ...
        ?>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody> @foreach($ticket_form_datas as $ticket_form_data)

                                                <tr>
                                                    <td style="width: 30%">{!! $ticket_form_data->getFieldKeyLabel() !!}
                                                    </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidd
                            en="true">&times;</span></button>
                    <h4 class="modal-title">{!! Lang::get('lang.edit') !!} <b>[#{!! $tickets->ticket_number !!}]</b>[{!!
                        $user->user_name !!}]</h4>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <spam id="error-sla" style="display:none" class="help-block text-red">This is a required
                                    field</spam>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis2">{!!
                        Lang::get('lang.close') !!}</button>
                    <button id="ban" type="button" class="btn btn-warning pull-right">{!! Lang::get('lang.ban_email')
                        !!}</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <button type="button" class="close" id="close101" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">{!! Lang::get('lang.change_owner_for_ticket') !!} <b>#{!!
                            $tickets->ticket_number !!}</b></h4>
                </div>
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ahah1" data-toggle="tab" style="color:green;" id="aa"><i
                                    class="fa fa-users"> </i> {!! Lang::get('lang.search_existing_users') !!}</a></li>
                        <li><a href="#haha2" data-toggle="tab" style="color:orange;"><i class="fa fa-user-plus"> </i>
                                {!! Lang::get('lang.add_new_user') !!}</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="ahah1">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary pull-right" id="submt2">{!!
                                    Lang::get('lang.update') !!}</button>
                            </div>
                            {!! Form::close()!!}
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis4">{!!
                        Lang::get('lang.close') !!}</button>
                    <button type="submit" class="btn btn-success pull-right" id="submt2">{!! Lang::get('lang.assign')
                        !!}</button>
                </div>
                {!! Form::close()!!}
            </div><!-- /.modal-content -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="dismis6">{!!
                        Lang::get('lang.close') !!}</button>
                    <button type="button" class="btn btn-warning pull-right" id="Surrender">{!!
                        Lang::get('lang.surrender') !!}</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#ahah" data-toggle="tab" style="color:green;" id="aa"><i
                                    class="fa fa-users"> </i> {!! Lang::get('lang.search_existing_users') !!}</a></li>
                        <li><a href="#haha" data-toggle="tab" style="color:orange;"><i class="fa fa-user-plus"> </i> {!!
                                Lang::get('lang.add_new_user') !!}</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="ahah">
                            <div class="modal-body" id="def">
                                <div class="callout callout-info" id="hide1234"><i class="icon fa fa-info">
                                    </i>&nbsp;&nbsp;&nbsp; {!! Lang::get('lang.search_existing_users_or_add_new_users')
                                    !!}</div>
                                <div id="here"></div>
                ...
                <div class="modal-body" id="surrender22">
                    ...
                    <div id="alert11" class="alert alert-dismissable" style="background-color:#F2F2F2">
                        ...
                        <button id="dismiss11" type="button" class="close" data-dismiss="alert"
                            onclick="remove_collaborator({!! $ccc->id !!})" aria-hidden="true">×</button>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" id="merge-close" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">{!! Lang::get('lang.merge-ticket') !!} </h4>&nbsp;<b>#{!!
                    $tickets->ticket_number !!}</b>
            </div><!-- /.modal-header-->
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <select class="form-control select2" id="select-merge-tickts" name="t_id[]"
                                    multiple="multiple" data-placeholder="{!! Lang::get('lang.select_tickets') !!}"
                                    style="width: 100%;">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="col-md-8">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{!! URL::route('ticket.thread',$tickets->id) !!}"><button type="button"
                            class="btn btn-primary yes"
                            data-dismiss="modal">{{Lang::get('lang.reload-now')}}</button></a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    var mymap = L.map('mapid',{center: [{{$tickets->latitude}}, {{$tickets->longitude}}],    minZoom:      2,    maxZoom:      18,    zoom:         14});
    var marker = L.marker([{{$tickets->latitude}}, {{$tickets->longitude}}]).addTo(mymap);
 L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: 'Map data &copy; <a href="http://openstreetmap.org" target="_blank">OpenStreetMap</a> Imagery © ',
        maxZoom:19,
      }).addTo(mymap);
    function clearAll() {
                $("#file_details").html("");
