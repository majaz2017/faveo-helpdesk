        ...
        <body class="skin-blue ">
            ...
            <div class="wrapper" id="RefreshAssign">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown user user-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        @endif
                                        @endif
                                        <span class="hidden-xs">{!! Auth::user()->firstname." ".Auth::user()->lastname
                                            !!}</span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-header">
                                            ...
                                            @endif
                                            <p>
                                                <span class="hidden-xs">{!! Auth::user()->firstname."
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview @yield('pages')">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li @yield('all-pages')><a href="{{url('page')}}"><i class="fa fa-circle-o"></i>
                                            {{Lang::get('lang.allpages')}}</a></li>
                                </ul>
                            </li>
                            <li class="treeview @yield('widget')">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li @yield('side1')><a href="{{url('side1')}}"><i class="fa fa-circle-o"></i>
                                            {{Lang::get('lang.sidewidget1')}}</a></li>
                                    <li @yield('side2')><a href="{{url('side2')}}"><i class="fa fa-circle-o"></i>
                                            {{Lang::get('lang.sidewidget2')}}</a></li>
                                    <li @yield('social')><a href="{{url('social')}}"><i class="fa fa-circle-o"></i>
                                            Social</a></li>
                                </ul>
                            </li>
                            <li @yield('comment')>
                ...
                <footer class="main-footer">
                    ...
                    <strong>Copyright &copy; {{date("Y")}} <a href="{{$settings->website}}">
                            {{$settings->company_name}}</a>. Powered By <a
                            href="http://www.faveohelpdesk.com">Faveo</a>.</strong>
                </footer>
            </div><!-- ./wrapper -->
