...
<ul>
    <li>
        <p>Unable to test database connection. Please make sure your database server is up and running and PHP is
            working with session.</p>
    </li>
</ul>
<p>If you have fixed all the errors. <a href="{{ URL::route('configuration') }}">Click here</a> to continue the
...
<div style="border-bottom: 1px solid #eee;">
    <p class="setup-actions step" id="retry">
        <a href="{{ URL::route('account') }}" class="pull-right" id="next" style="text-color:black"><input type="submit"
                id="submitme" class="button-primary button button-large button-next" value="Continue"> </a>
        <a href="{{ URL::route('configuration') }}" class="button button-large button-next"
...
<p>If you&rsquo;re unsure what these terms mean you should probably contact your host. If you still need help you can
    always visit the <a href="http://www.ladybirdweb.com/support">Faveo Support </a>.</p>


<div style="border-bottom: 1px solid #eee;">
    @if(Cache::has('step4')) <?php Cache::forget('step4') ?> @endif
    <p class="setup-actions step">
        <input type="button" id="submitme" class="button-danger button button-large button-next"
...
<div id="legend">
    ...
    <p class="setup-actions step">
        ...
        <span class="warning">Warning</span> &mdash; Not a deal breaker, but it's recommended to have this installed for
        some features to work<br />
        <span class="error">Error</span> &mdash; Crm Alexor require this feature and can't work without it<br />
    </p>
    {{-- </ul> --}}
</div>
<?php } // if  ?>
