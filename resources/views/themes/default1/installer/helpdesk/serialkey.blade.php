...
<div class="wc-setup-content" ng-app="myApp">
    <h1 style="text-align: center;">Crm Alexor Serial Key</h1>
    <p><strong>Please enter your serial key for Crm Alexor PRO</strong></p>
        ...
        <tr>
            ...
            <td ng-repeat="productKey in productKeys" style="margin-left: 150px;">
                ...
                <div class="container">
                    ...
                    <input type="text" name="second" id="productKey2" ng-model="productKey.set2" maxlength="4" size="4"
                        style="padding: 3px; margin-left: 3px; width: 50px;">&nbsp;-
                    <input type="text" name="third" id="productKey3" ng-model="productKey.set3" maxlength="4" size="4"
                        style="padding: 3px; margin-left: 3px; width: 50px;">&nbsp;-
                    <input type="text" name="forth" id="productKey4" ng-model="productKey.set4" maxlength="4" size="4"
                        style="padding: 3px; margin-left: 3px; width: 50px;">
                </div>
            </td>
        </tr>
