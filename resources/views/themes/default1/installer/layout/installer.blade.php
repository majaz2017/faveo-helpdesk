...
=======
        <link href="{{asset("lb-faveo/media/images/favicon.ico")}}" rel="shortcut icon" />
>>>>>>> 35a953daa04f944a798f76a729ed0e16bbb2fd20
    ...
    <body class="setup wp-core-ui">
        ...
        <p style="text-align: center;"> Copyright &copy; 2015 - <?php echo date('Y')?> · Ladybird Web Solution Pvt Ltd.
            All Rights Reserved. Powered by <a target="_blank" href="http://www.faveohelpdesk.com">Faveo </a></p>
