		...
		?>
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href=""><i class="fa fa-circle-o"></i>Open<small
                                                class="label pull-right bg-green">{!! $open !!}</small></a></li>
                                    <li><a href=""><i class="fa fa-circle-o"></i>Inprogress<small
                                                class="label pull-right bg-green">{!! $underprocess !!}</small></a></li>
                                    <li><a href=""><i class="fa fa-circle-o"></i>Closed<small
                            ...
                            <div class="tabs-content">
                                <div class="tabs-pane @yield('dashboard-bar')" id="tabA">
                                    <ul class="nav navbar-nav">
                                        <li id="bar" @yield('dashboard')><a href="{{url('dashboard')}}">Dashboard</a>
                                        </li>
                                ...
                                <div class="tabs-pane @yield('user-bar')" id="tabB">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li id="bar" @yield('organizations')><a
                                                href="{{ url('organizations') }}">Organizations</a></li></a></li>
                                    </ul>
                                </div>
                                <div class="tabs-pane @yield('ticket-bar')" id="tabC">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li id="bar" @yield('answered')><a
                                                href="{{ url('/ticket/answered') }}">Answered</a>
                                        </li>
                                        <li id="bar" @yield('myticket')><a href="{{ url('/ticket/myticket') }}">My
                                                Ticket</a></li>
                                        {{-- <li id="bar" @yield('ticket')><a href="{{ url('ticket') }}" >Ticket</a>
                                        </li>
                                        --}}
                                        <li id="bar" @yield('overdue')><a
                                                href="{{ url('/ticket/overdue') }}">Overdue</a>
                                        </li>
                                        <li id="bar" @yield('closed')><a href="{{ url('/ticket/closed') }}">Closed</a>
                                        </li>
...
?>
                ...
                <footer class="main-footer">
                    ...
                    <strong>Copyright &copy; {!! date('Y') !!} <a href="{!! $company->website !!}">{!!
                        ...
                        href="http://www.alexor.co.il/">alexor</a>
                </footer>
            </div><!-- ./wrapper -->
