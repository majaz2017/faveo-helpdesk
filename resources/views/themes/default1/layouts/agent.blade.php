                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse">
                        <div class="tabs-content">
                            ...
                            <div class="tabs-pane @yield('user-bar')" id="tabB">
                                <ul class="nav navbar-nav">
                                    <li id="bar" @yield('user')><a href="{{ url('user') }}">User Directory</a></li></a>
                                    </li>
                            ...
                            <div class="tabs-pane @yield('ticket-bar')" id="tabC">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li id="bar" @yield('answered')><a href="{{ url('/ticket/answered') }}">Answered</a>
                                    </li>
                                    <li id="bar" @yield('myticket')><a href="{{ url('/ticket/myticket') }}">My
                                            Ticket</a></li>
                                    {{-- <li id="bar" @yield('ticket')><a href="{{ url('ticket') }}" >Ticket</a></li>
                                    --}}
                                    <li id="bar" @yield('overdue')><a href="{{ url('/ticket/overdue') }}">Overdue</a>
                                    </li>
