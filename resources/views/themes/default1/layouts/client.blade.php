						...
						<div id="navbar" class="navbar-wrapper text-center">
							<nav class="navbar navbar-default site-navigation" role="navigation">
											...
											<li>
												<div class="banner-wrapper user-menu text-center clearfix">
													...
													<div class="banner-content">
														...
														btn-custom
														btn-xs">Edit Profile</a> --}} <a href="{{url('auth/logout')}}"
															class="btn btn-custom btn-xs">Log out</a>
													</div>
												</div>
											</li>
										</ul>
								...
								<ul class="nav navbar-nav navbar-login">
									<li><a href="#" class="collapsed" data-toggle="collapse"
											data-target="#login-form">Login
											<i class="sub-indicator fa fa-chevron-circle-down fa-fw text-muted"></i></a>
									</li>
								</ul><!-- .navbar-login -->
						...
						<div class="row">
							<div class="site-info col-md-6">
								<p class="text-muted">Copyright &copy; {!! date('Y') !!} <a
									...
									reserved. Powered by <a href="http://www.alexor.co.il/">alexor</a></p>
							</div>
						</div>
				</footer><!-- #colophon -->
				<!-- jQuery 2.1.1 -->
