                                        ...
                                        <li class="user-footer" style="background-color:#1a2226;">
                                            <div class="pull-left">
                                                <a href="{{url('admin-profile')}}"
                                                    class="btn btn-info btn-sm"><b>Profile</b></a>
                                            </div>
                                            <div class="pull-right">
                                                <a href="{{url('auth/logout')}}" class="btn btn-danger btn-sm"><b>Sign
                                                        out</b></a>
                                            </div>
                                        </li>
                                    </ul>
     ...
     ?>
                            <li>
                                <a href="{{ url('/ticket/open') }}">
                                    <i class="fa fa-envelope"></i> <span>Inbox</span> <small
                                        class="label pull-right bg-green"><?php echo $i;?></small>
                                </a>
                            </li>
                            <?php
//}
?>
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse">
                            <div class="tabs-content">
                                ...
                                <div class="tabs-pane @yield('staffs-bar')" id="tabB">
                                    <ul class="nav navbar-nav">
                                        <li id="bar" @yield('staffs')><a href="{{ url('agents') }}">Staffs</a></li></a>
                                        </li>
                                        <li id="bar" @yield('departments')><a
                                                href="{{ url('departments') }}">Departments</a></li></a></li>
                                        <li id="bar" @yield('teams')><a href="{{ url('teams') }}">Teams</a></li></a>
                                        </li>
                                        <li id="bar" @yield('groups')><a href="{{ url('groups') }}">Groups</a></li></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tabs-pane @yield('emails-bar')" id="tabC">
                                    <ul class="nav navbar-nav">
                                        <li id="bar" @yield('emails')><a href="{{ url('emails') }}">Emails</a></li></a>
                                        </li>
                                        <li id="bar" @yield('ban')><a href="{{ url('banlist') }}">Ban List</a></li>
                                        <li id="bar" @yield('template')><a href="{{ url('template') }}">Template</a>
                                        </li>
                                        <li id="bar" @yield('diagno')><a href="{{ url('getdiagno') }}">Diagnostic</a>
                                        </li>
                                ...
                                <div class="tabs-pane @yield('settings-bar')" id="tabE">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li id="bar" @yield('auto-response')><a
                                                href="{{url('getresponder')}}">Auto-Responce</a></li>
                                        <li id="bar" @yield('alert')><a href="{{url('getalert')}}">Alert & Notice</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tabs-pane @yield('theme-bar')" id="tabF">
                                    <ul class="nav navbar-nav">
                                        <li id="bar" @yield('footer')><a href="{{ url('create-footer') }}">Footer</a>
                                        </li>
                                        </a></li>
                                        <li id="bar" @yield('footer2')><a href="{{ url('create-footer2') }}">Footer2</a>
                                        </li></a></li>
                                        <li id="bar" @yield('footer3')><a href="{{ url('create-footer3') }}">Footer3</a>
                                        </li></a></li>
                                        <li id="bar" @yield('footer4')><a href="{{ url('create-footer4') }}">Footer4</a>
                                        </li></a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <footer class="main-footer">
                    ...
                    <strong>Copyright &copy; {!! date('Y') !!} <a href="{!! $company->website !!}">{!!
                        ...
                        href="http://www.alexor.co.il/" target="blank">alexor</a>
                </footer>
            </div><!-- ./wrapper -->
